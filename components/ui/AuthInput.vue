<template>
  <div class="form-group">
    <label v-if="label" :for="id" class="block text-sm font-medium text-white/90 mb-2">
      {{ label }}
    ...
    <p v-if="hint" class="mt-1 text-sm text-white/60">
      {{ hint }}
    </p>
  </div>
</template>
...
defineEmits(['update:modelValue', 'blur', 'focus', 'keyup-enter'])
</script> 